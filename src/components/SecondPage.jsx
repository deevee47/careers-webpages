    ...
    <div className="font-sans bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-36">
            {services.map((product, index) => (
              ...
              >
                <img className="rounded-t-3xl" src="xx.jpeg" alt="" srcset="" />
                <h3 className="text-2xl p-6 font-semibold mb-2 text-gray-800">
                  {product.title}
                </h3>
      ...
      >
        <div className=" mx-auto px-4">
          ...
          <div className="mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6 px-36">
            {products.map((product, index) => (
              ...
              >
                <img
                  ...
                  srcset=""
                />
                <h3 className=" text-2xl px-6 py-2 font-semibold mb-2 text-gray-800">
                  {product.title}
                </h3>
                <p className="px-6 pb-6 text-gray-600">{product.description}</p>
              </motion.div>
